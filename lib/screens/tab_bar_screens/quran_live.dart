...
class QuranLive extends StatefulWidget {
  ...
  @override
  State<QuranLive> createState() => _QuranLiveState();
}

class _QuranLiveState extends State<QuranLive> {
  ...
  void initState() {
    super.initState();
    controller = VideoPlayerController.networkUrl(Uri.parse('https://win.holol.com/live/quran/playlist.m3u8'));
